        ...
        <div className="div_form">
          <form className="firstForm">
            ...
            <input
              id="input7"
              onChange={handleChange}
              value={dataForm.teacher_comunication}
              type="text"
              name="teacher_comunication"
            />
